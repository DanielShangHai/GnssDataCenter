...
// GNSSRefDataCenterView.cpp : CGNSSRefDataCenterView 类的实现
//
...
CGNSSRefDataCenterDoc* CGNSSRefDataCenterView::GetDocument() const // 非调试版本是内联的
{
